...
(function (T, V, s) {
    ...
    function v(b) {
        return function () {
            var a = arguments[0], c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.19/" + (b ? b + "/" : "") + a;
    ...
    function Ga(b, a, c, d) {
        ...
        if (a) {
            ...
            if (L(b))for (var g = a.length = 0; g < b.length; g++)e = Ga(b[g], null, c, d), U(b[g]) && (c.push(b[g]), d.push(e)), a.push(e); else {
                var f = a.$$hashKey;
                q(a, function (b, c) {
                    delete a[c]
                });
    ...
    function la(b, a) {
        if (L(b)) {
            ...
            for (var c = 0; c < b.length; c++)a[c] =
                b[c]
        } else if (U(b))for (c in a = a || {}, b)!yb.call(b, c) || "$" === c.charAt(0) && "$" === c.charAt(1) || (a[c] = b[c]);
        return a || b
    }
    ...
    function $c(b) {
        E(b, {bootstrap: cc,
            copy: Ga, extend: E, equals: ya, element: x, forEach: q, injector: dc, noop: A, bind: zb, toJson: sa, fromJson: $b, identity: Fa, isUndefined: D, isDefined: B, isString: y, isFunction: O, isObject: U, isNumber: xb, isElement: Uc, isArray: L, version: ad, isDate: Oa, lowercase: I, uppercase: Ha, callbacks: {counter: 0}, $$minErr: v, $$csp: Zb});
        Va = Zc(T);
        try {
            Va("ngLocale")
        } catch (a) {
    ...
    function mc(b, a, c) {
        var d = ma(b, "data"), e = B(c), g = !e && B(a), f = g && !U(a);
        d || f || ma(b, "data", d = {});
    ...
    function te(b, a, c, d) {
        ...
        var K = h.href, Q = a.find("base"), z = null;
        k.url = function (a, c) {
        ...
        k.cookies = function (a, b) {
            ...
            if (a)b === s ? m.cookie = escape(a) + "=;path=" + C + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : y(b) && (d = (m.cookie = escape(a) + "=" + escape(b) + ";path=" + C).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")); else {
                if (m.cookie !== ca)for (ca = m.cookie,
    ...
    function fc(b, a) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, l, p, n, r, t, J, w, u, K, Q) {
            ...
            function ca(a, b, c, d, f) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        a = a.className;
                        if (y(a) && "" !== a)for (; m = g.exec(a);)l = na(m[2]), ba(b, l, "C", d, f) && (c[l] = aa(m[3])), a = a.substr(m.index + m[0].length);
                        break;
                    case 3:
                        v(b, a.nodeValue);
                        break;
            ...
            function H(a, c, d, e, g, f, m, p, n) {
                function w(a, b, c, d) {
                    ...
                    if (b) {
                        ...
                        b.require = F.require;
                        b.directiveName = oa;
                        if (M === F || F.$$isolateScope)b = tc(b, {isolateScope: !0});
                        p.push(b)
                    }
                }
                ...
                function K(a, e, g, f, n) {
                    ...
                    if (M) {
                        ...
                        q(M.scope, function (a, c) {
                            var d = a.match(ba) || [], g = d[3] || c, f = "?" == d[2], d = d[1], m, l, p, n;
                    ...
                    mb = n && w;
                    N && q(N, function (a) {
                        var b = {$scope: a === M || a.$$isolateScope ? C : e, $element: R, $attrs: u, $transclude: mb},
                            c;
                        G = a.controller;
                        "@" == G && (G = u[a.name]);
                        c = t(G, b);
                ...
                n = n || {};
                for (var u =
                    -Number.MAX_VALUE, Q, N = n.controllerDirectives, M = n.newIsolateScopeDirective, H = n.templateDirective, ba = n.nonTlbTranscludeDirective, D = !1, E = !1, Da = n.hasElementTranscludeDirective, v = d.$$element = x(c), F, oa, X, T = e, S, P = 0, pa = a.length; P < pa; P++) {
                    F = a[P];
                    var W = F.$$start, Y = F.$$end;
                    W && (v = C(c, W, Y));
                    X = s;
                    ...
                    if (X = F.transclude)D = !0, F.$$tlb || (I("transclusion", ba, F, v), ba = F), "element" == X ? (Da = !0, u = F.priority, X = C(c, W, Y), v = d.$$element = x(V.createComment(" " + oa + ": " + d[oa] + " ")), c = v[0], nb(g, x(za.call(X, 0)), c), T = z(X, e, u, f && f.name, {nonTlbTranscludeDirective: ba})) : (X = x(Ib(c)).contents(), v.empty(), T = z(X, e));
                    if (F.template)if (E = !0, I("template", H, F, v), H = F, X = O(F.template) ? F.template(v, d) : F.template, X = Z(X), F.replace) {
                        f = F;
                        X = Gb.test(X) ? x(aa(X)) : [];
                        c = X[0];
                    ...
                    if (F.templateUrl)E = !0, I("template", H, F, v), H = F, F.replace && (f = F), K = A(a.splice(P, a.length - P), v, d, g, D && T, m, p, {controllerDirectives: N, newIsolateScopeDirective: M, templateDirective: H, nonTlbTranscludeDirective: ba}), pa = a.length; else if (F.compile)try {
            ...
            var Da = b.startSymbol(), pa = b.endSymbol(), Z = "{{" == Da || "}}" == pa ? Fa : function (a) {
    ...
    function Ud() {
        ...
        }], headers: {common: {Accept: "application/json, text/plain, */*"}, post: la(d), put: la(d), patch: la(d)}, xsrfCookieName: "XSRF-TOKEN",
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, p, n) {
            function r(a) {
                ...
                var c = {method: "get", transformRequest: e.transformRequest, transformResponse: e.transformResponse}, d = function (a) {
                    ...
                    var c = e.headers, d = E({}, a.headers), g, f, c = E({}, c.common, c[I(a.method)]);
                    b(c);
                    b(d);
                    a:for (g in c) {
                        a = I(g);
    ...
    function xe(b, a, c, d, e) {
        function g(a, b, c) {
            ...
            f = function (a) {
                ...
                g = null;
                var k = -1, t = "unknown";
                a && ("load" !== a.type || d[b].called || (a = {type: "error"}), t = a.type, k = "error" === a.type ?
                    404 : 200);
                c && c(k, t)
            };
            ob(g, "load", f);
    ...
    function Bc(b, a) {
        ...
        this.$$compose = function () {
            var a = Ab(this.$$search), b = this.$$hash ? "#" + gb(this.$$hash) : "";
    ...
    function Pb(b, a) {
        ...
        this.$$compose = function () {
            var c = Ab(this.$$search), e = this.$$hash ?
                "#" + gb(this.$$hash) : "";
    ...
    function Qb(b, a) {
        ...
        this.$$compose = function () {
            var c = Ab(this.$$search), e = this.$$hash ? "#" + gb(this.$$hash) : "";
            this.$$url = Mb(this.$$path) + (c ? "?" + c : "") + e;
    ...
    function Ec(b, a, c) {
        ...
        if (a.unwrapPromises || 1 !== e)if (a.unwrapPromises || 2 !== e)if (a.csp)g = 6 > e ? Dc(d[0], d[1], d[2], d[3], d[4], c, a) : function (b, g) {
            var f = 0, k;
            do k =
        ...
        } else g = Ae(d[0], d[1], c); else g = ze(d[0], c);
    ...
    function ge() {
        this.$get = ["$window", "$timeout", function (b, a) {
            var c = b.requestAnimationFrame ||
                b.webkitRequestAnimationFrame || b.mozRequestAnimationFrame, d = b.cancelAnimationFrame || b.webkitCancelAnimationFrame || b.mozCancelAnimationFrame || b.webkitCancelRequestAnimationFrame, e = !!c, g = e ? function (a) {
                var b = c(a);
                return function () {
                    d(b)
                }
            ...
            k.prototype = {constructor: k, $new: function (a) {
                ...
                $watchCollection: function (a, b) {
                    ...
                    return this.$watch(function () {
                        d = m(c);
                        var a, b;
                        if (U(d))if (db(d))for (e !== l && (e = l, q = e.length = 0, h++), a = d.length, q !== a && (h++, e.length = q = a), b = 0; b < a; b++)e[b] !== e[b] && d[b] !== d[b] || e[b] === d[b] || (h++, e[b] = d[b]); else {
                            e !== n && (e = n = {}, q = 0, h++);
                            a = 0;
                        ...
                        } else for (a in f = {}, d)yb.call(d, a) && (f[a] = d[a]); else f = d
                    })
                }, $digest: function () {
                    var d, g, f, k, h = this.$$asyncQueue, l = this.$$postDigestQueue, q, z, s = b, N, M = [], x, C, G;
                    m("$digest");
                    c = null;
                    do {
                        z = !1;
                        ...
                        a:do {
                            if (k = N.$$watchers)for (q = k.length; q--;)try {
                                if (d = k[q])if ((g =
                                    d.get(N)) !== (f = d.last) && !(d.eq ? ya(g, f) : "number" === typeof g && "number" === typeof f && isNaN(g) && isNaN(f)))z = !0, c = d, d.last = d.eq ? Ga(g, null) : g, d.fn(g, f === p ? g : f, N), 5 > s && (x = 4 - s, M[x] || (M[x] = []), C = O(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, C += "; newVal: " + sa(g) + "; oldVal: " + sa(f), M[x].push(C)); else if (d === c) {
                                    z = !1;
                                    break a
                                }
                            } catch (B) {
    ...
    function cd() {
        ...
        this.$get = function () {
            return function (c, d) {
                var e = d ? a : b, g;
                if (!P || 8 <=
                    P)if (g = ta(c).href, "" !== g && !g.match(e))return"unsafe:" + g;
                return c
            }
        }
    }
    ...
    function ta(b, a) {
        ...
        return{href: W.href, protocol: W.protocol ? W.protocol.replace(/:$/,
            "") : "", host: W.host, search: W.search ? W.search.replace(/^\?/, "") : "", hash: W.hash ? W.hash.replace(/^#/, "") : "", hostname: W.hostname, port: W.port, pathname: "/" === W.pathname.charAt(0) ? W.pathname : "/" + W.pathname}
    }
        ...
        return function (b, a, c) {
            ...
            "function" !== d && (c = "boolean" === d && c ? function (a, b) {
                ...
                if (a && b && "object" === typeof a && "object" === typeof b) {
                    for (var d in a)if ("$" !== d.charAt(0) && yb.call(a, d) && c(a[d], b[d]))return!0;
                    return!1
                }
                b = ("" + b).toLowerCase();
    ...
    function Mc(b, a, c, d, e) {
        ...
        if (h)0 < e && (-1 < b && 1 > b) && (k = b.toFixed(e)); else {
            ...
            if (f.length >=
                p + n)for (l = f.length - p, h = 0; h < l; h++)0 === (l - h) % n && 0 !== h && (k += c), k += f.charAt(h);
    ...
    function Oc(b, a, c, d) {
        ...
        var g = this, f = b.parent().controller("form") || ub, k = 0, m = g.$error = {}, h = [];
        ...
        g.$setValidity = function (a, b, c) {
            ...
            if (b)d && (Qa(d, c), d.length || (k--, k ||
                (e(b), g.$valid = !0, g.$invalid = !1), m[a] = !1, e(!0, a), f.$setValidity(a, !0, g))); else {
                k || e(b);
                if (d) {
                    if (-1 != Pa(d, c))return
    ...
    function wb(b, a, c, d, e, g) {
        var f = a.prop(Me), k = a[0].placeholder, m = {};
        d.$$validityState = f;
        if (!e.android) {
            var h = !1;
        ...
        var l = function (e) {
            if (!h) {
                ...
                if (P && "input" === (e || m).type && a[0].placeholder !== k)k =
                    a[0].placeholder; else if (Sa(c.ngTrim || "T") && (g = aa(g)), e = f && d.$$hasNativeValidators, d.$viewValue !== g || "" === g && e)b.$$phase ? d.$setViewValue(g) : b.$apply(function () {
                    d.$setViewValue(g)
                })
            }
        };
    ...
    var Me = "validity", I = function (b) {
        return y(b) ? b.toLowerCase() : b
    }, yb = Object.prototype.hasOwnProperty, Ha = function (b) {
        return y(b) ? b.toUpperCase() : b
    }, P, x, Ca, za = [].slice, Ne = [].push, xa = Object.prototype.toString, Ra = v("ng"), Ta = T.angular || (T.angular = {}), Va, La, ka = ["0", "0", "0"];
    P = Z((/msie (\d+)/.exec(I(navigator.userAgent)) || [])[1]);
    isNaN(P) && (P = Z((/trident\/.*; rv:(\d+)/.exec(I(navigator.userAgent)) ||
        [])[1]));
    A.$inject = [];
    Fa.$inject = [];
    var L = function () {
    ...
    var Yc = /[A-Z]/g, ad = {full: "1.2.19",
        major: 1, minor: 2, dot: 19, codeName: "precognitive-flashbacks"};
    S.expando = "ng339";
    var Ya = S.cache = {}, ne = 1, ob = T.document.addEventListener ? function (b, a, c) {
    ...
    var ie = /([\:\-\_]+(.))/g, je = /^moz([A-Z])/, Fb = v("jqLite"), ke = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Gb = /<|&#?\w+;/,
        le = /<([\w:]+)/, me = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ea = {option: [1, '<select multiple="multiple">', "</select>"], thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""]};
    ...
    }, length: 0, push: Ne, sort: [].sort, splice: [].splice}, lb = {};
    ...
    q({data: mc,
        inheritedData: kb, scope: function (b) {
            ...
            var d = I(a);
            if (lb[d])if (B(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || A).specified ? d : s; else if (B(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), null === b ? s : b
        }, prop: function (b, a, c) {
    ...
    q({removeData: kc, dealoc: Ia, on: function a(c, d, e, g) {
        ...
        var f = ma(c, "events"), k = ma(c, "handle");
        f || ma(c, "events", f = {});
    ...
    }, addClass: jb, removeClass: ib, toggleClass: function (a, c, d) {
    ...
    var qe = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, re = /,/, se = /^\s*(_?)(\S+?)\1\s*$/, pe = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, $a = v("$injector"), Oe = v("$animate"), Md = ["$provide", function (a) {
        this.$$selectors = {};
    ...
    var ve = /^(x[\:\-_]|data[\:\-_])/i, yc = v("$interpolate"), Pe = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, ye = {http: 80, https: 443, ftp: 21}, Ob = v("$location");
    Qb.prototype = Pb.prototype = Bc.prototype = {$$html5: !1, $$replace: !1, absUrl: pb("$$absUrl"), url: function (a, c) {
        ...
        this.hash(d[5] || "", c);
        return this
    }, protocol: pb("$$protocol"), host: pb("$$host"), port: pb("$$port"), path: Cc("$$path", function (a) {
        ...
        switch (arguments.length) {
            case 0:
                return this.$$search;
            case 1:
                if (y(a))this.$$search = bc(a); else if (U(a))this.$$search = a; else throw Ob("isrcharg");
                break;
            default:
    ...
    var ja = v("$parse"), Fc = {}, ua, Qe = Function.prototype.call, Re = Function.prototype.apply, Qc = Function.prototype.bind, cb = {"null": function () {
        return null
    }, "true": function () {
        return!0
    }, "false": function () {
    ...
    Sb.prototype = {constructor: Sb, lex: function (a) {
        ...
        for (this.tokens = []; this.index < this.text.length;) {
            ...
            if (this.is("\"'"))this.readString(this.ch); else if (this.isNumber(this.ch) ||
                this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(); else if (this.is("(){}[].,;:?"))this.tokens.push({index: this.index, text: this.ch}), this.index++; else if (this.isWhitespace(this.ch)) {
                this.index++;
                continue
            } else {
                a = this.ch + this.peek();
                var c = a + this.peek(2), d = cb[this.ch], e = cb[a], g = cb[c];
                g ? (this.tokens.push({index: this.index, text: c, fn: g}), this.index += 3) : e ? (this.tokens.push({index: this.index, text: a, fn: e}), this.index += 2) : d ? (this.tokens.push({index: this.index,
                    text: this.ch, fn: d}), this.index += 1) : this.throwError("Unexpected next character ", this.index, this.index + 1)
            }
            this.lastCh = this.ch
        }
        return this.tokens
        ...
        for (var d = "", e = a, g = !1; this.index < this.text.length;) {
            ...
            if (g)"u" === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Se[f]) ? d + g : d + f, g = !1; else if ("\\" === f)g = !0; else {
                if (f === a) {
                    this.index++;
    ...
    bb.prototype = {constructor: bb, parse: function (a) {
        ...
        var a;
        if (this.expect("("))a = this.filterChain(), this.consume(")"); else if (this.expect("["))a = this.arrayDeclaration(); else if (this.expect("{"))a =
            this.object(); else {
            var c = this.expect();
        ...
        for (var a = this.expression(), c; ;)if (c = this.expect("|"))a = this.binaryFn(a,
            c.fn, this.filter()); else return a
    }, filter: function () {
    ...
    var ub = {$addControl: A, $removeControl: A, $setValidity: A, $setDirty: A, $setPristine: A};
    ...
    var Rc = function (a) {
        ...
        }, ed = Rc(), rd = Rc(!0), Te = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Ue = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i, Ve = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Sc = {text: wb, number: function (a, c, d, e, g, f) {
            wb(a, c, d, e, g, f);
            e.$parsers.push(function (a) {
                var c = e.$isEmpty(a);
                if (c || Ve.test(a))return e.$setValidity("number",
        ...
        }, hidden: A, button: A, submit: A, reset: A, file: A}, We = ["badInput"], gc = ["$browser", "$sniffer", function (a, c) {
            return{restrict: "E", require: "?ngModel",
                link: function (d, e, g, f) {
                    f && (Sc[I(g.type)] || Sc.text)(d, e, g, f, c, a)
                }}
        }], tb = "ng-valid", sb = "ng-invalid", Na = "ng-pristine", vb = "ng-dirty", Xe = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", function (a, c, d, e, g, f) {
            function k(a, c) {
                c = c ? "-" + hb(c, "-") : "";
            ...
            var l = e.inheritedData("$formController") || ub, p = 0, n = this.$error = {};
            e.addClass(Na);
            k(!0);
            ...
            return{require: ["ngModel", "^?form"], controller: Xe, link: function (a, c, d, e) {
                var g = e[0], f = e[1] || ub;
                f.$addControl(g);
    ...
    var td = ["$animate", function (a) {
        ...
        return{transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, g, f, k, m) {
            ...
            e.$watchCollection(k, function (a) {
                var f, k, l = g[0], p, u = {}, C, G, H, v, y, A, D = [];
                ...
                C = y.length;
                k = D.length = y.length;
                for (f = 0; f < k; f++)if (H = a === y ? f : y[f], v = a[H], v = p(H, v, f), Ba(v, "`track by` id"), B.hasOwnProperty(v))A = B[v], delete B[v], u[v] =
                    A, D[f] = A; else {
    ...
    }], Ze = v("ngOptions"), Ed = $({terminal: !0}), gd = ["$compile", "$parse", function (a, c) {
        ...
        return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
            ...
            function p(e, f, g) {
                function k() {
                    ...
                    t = g.$modelValue;
                    z = x(e) || [];
                    var D = n ? Vb(z) : z, G, R, C;
                    R = {};
                    s = !1;
                    var E, I;
                    if (r)if (w && L(t))for (s = new Za([]), C = 0; C < t.length; C++)R[m] = t[C], s.put(w(e, R), t[C]); else s = new Za(t);
                    for (C = 0; G = D.length,
                        C < G; C++) {
                        h = C;
                        if (n) {
                        ...
                        E = l(e, R);
                        E = B(E) ? E : "";
                        h.push({id: w ? w(e, R) : n ? D[C] : C, label: E, selected: d})
                    }
            ...
            if (m[1]) {
                var n = m[0];
                m = m[1];
                var r = k.multiple, t = k.ngOptions, v = !1, w, u = x(V.createElement("option")), A = x(V.createElement("optgroup")), y = u.clone();
                k = 0;
                for (var z = f.children(), E = z.length; k < E; k++)if ("" ===
                    z[k].value) {
                    w = v = z.eq(k);
                    break
                }
    ...
    T.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : ((Ca = T.jQuery) && Ca.fn.on ? (x = Ca, E(Ca.fn, {scope: Ka.scope, isolateScope: Ka.isolateScope, controller: Ka.controller, injector: Ka.injector, inheritedData: Ka.inheritedData}), Eb("remove", !0, !0, !1), Eb("empty", !1, !1, !1), Eb("html", !1, !1, !0)) : x = S, Ta.element = x, $c(Ta), x(V).ready(function () {
        Xc(V,
            cc)
    }))
})(window, document);
